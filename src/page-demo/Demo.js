                            ...
                            <div className="row">
                                <div className="col-lg-12">
                                    <div className="inner text-center">
                                        <span>Tutorial de React para individuos de aveiro</span>
                                        <h2 className="mt--20 theme-gradient font-700">Let's go Lalland</h2>
                                        <div className="footer-btn mt--35">
                                            <a className="btn-default" target="_blank" href="https://themeforest.net/checkout/from_item/31405042?license=regular"><span>Compra</span></a>
                                        </div>
                                    </div>
                                </div>
                            </div>
